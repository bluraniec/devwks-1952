...
```sql
SELECT count("connection_state") FROM "autogen"."Cisco-IOS-XR-ipv4-bgp-oper:bgp/instances/instance/instance-active/default-vrf/neighbors/neighbor" WHERE ("neighbor_address" = '192.168.0.2' AND 'connection_state' = 'bgp-st-estab') AND $timeFilter GROUP BY time(3s) fill(null)
```  
